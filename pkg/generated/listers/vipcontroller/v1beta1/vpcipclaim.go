...
// List lists all VpcIpClaims in the indexer.
func (s *vpcIpClaimLister) List(selector labels.Selector) (ret []*v1beta1.VpcIpClaim, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.VpcIpClaim))
	})
	return ret, err
}
...
// List lists all VpcIpClaims in the indexer for a given namespace.
func (s vpcIpClaimNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.VpcIpClaim, err error) {
...
// Get retrieves the VpcIpClaim from the indexer for a given namespace and name.
func (s vpcIpClaimNamespaceLister) Get(name string) (*v1beta1.VpcIpClaim, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("vpcipclaim"), name)
	}
	return obj.(*v1beta1.VpcIpClaim), nil
}
